...
-(int)adjustSpawn:(int)s
{
    ...
    {
        case MS_LOW:
            return floor((float)(s) * 0.5f);
            break;
        case MS_HIGH:
            return ceil((float)(s) * 1.3f);
            break;
        case MS_MED:
        default:
            return s;
...
-(void)initRounds
{
    ...
    [rounds addObject:[[Round alloc] initWithMessage1:nil //30
                                             message2:nil
                                             message3:nil
                                                bonus:0 chubbies:[self adjustSpawn:10] jeanies:[self adjustSpawn:10] lankies:[self adjustSpawn:10] smarties:[self adjustSpawn:10] airplanes:[self adjustSpawn:10]
                                              banners:[self adjustSpawn:10] bandies:[self adjustSpawn:10] cheeries:[self adjustSpawn:20] punkies:[self adjustSpawn:10] mascots:[self adjustSpawn:10] queenies:[self adjustSpawn:12]]];
    [rounds addObject:[[Round alloc] initWithMessage1:@"130 enemies on their way for"
                                             ...
                                             message3:@"you've beat the game!"
                                                bonus:150 chubbies:[self adjustSpawn:14] jeanies:0 lankies:0 smarties:0 airplanes:[self adjustSpawn:12]
                                              banners:[self adjustSpawn:10] bandies:[self adjustSpawn:12] cheeries:0 punkies:0 mascots:[self adjustSpawn:7] queenies:[self adjustSpawn:5]]];
    [rounds addObject:[[Round alloc] initWithMessage1:@"The penultimate round!"
                                             message2:@"These kids are getting"
                                             message3:@"serious."
                                                bonus:125 chubbies:0 jeanies:[self adjustSpawn:20] lankies:[self adjustSpawn:16] smarties:[self adjustSpawn:24] airplanes:0
                                              banners:0 bandies:0 cheeries:[self adjustSpawn:22] punkies:[self adjustSpawn:18] mascots:0 queenies:0]];
    [rounds addObject:[[Round alloc] initWithMessage1:@"In the home stretch, soon"
                                             message2:@"you can return to playing"
                                             message3:@"Candy Crush!"
                                                bonus:115 chubbies:[self adjustSpawn:6] jeanies:[self adjustSpawn:6] lankies:[self adjustSpawn:6] smarties:[self adjustSpawn:6] airplanes:[self adjustSpawn:6]
                                              banners:6 bandies:[self adjustSpawn:6] cheeries:[self adjustSpawn:6] punkies:6 mascots:[self adjustSpawn:6] queenies:[self adjustSpawn:6]]];
    [rounds addObject:[[Round alloc] initWithMessage1:@"Here comes each enemy type"
                                             message2:@"Hope your layout has"
                                             message3:@"some variety."
                                                bonus:105 chubbies:[self adjustSpawn:12] jeanies:0 lankies:0 smarties:0 airplanes:0
                                              banners:0 bandies:[self adjustSpawn:10] cheeries:0 punkies:0 mascots:[self adjustSpawn:8] queenies:3]];
    [rounds addObject:[[Round alloc] initWithMessage1:@"By now you should have" //25
                                             ...
                                             message3:@"committed to memory."
                                                bonus:100 chubbies:0 jeanies:20 lankies:[self adjustSpawn:20] smarties:0 airplanes:0
                                              banners:0 bandies:0 cheeries:[self adjustSpawn:20] punkies:0 mascots:0 queenies:[self adjustSpawn:5]]];
    [rounds addObject:[[Round alloc] initWithMessage1:@"After this round, enemy"
                                             ...
                                             message3:@"they were at round 1."
                                              ...
                                              banners:0 bandies:[self adjustSpawn:5] cheeries:5 punkies:0 mascots:[self adjustSpawn:10] queenies:[self adjustSpawn:5]]];
    [rounds addObject:[[Round alloc] initWithMessage1:@"If you haven't invested in a"
                                             ...
                                             message3:@"recommend it."
                                              ...
                                              banners:0 bandies:0 cheeries:[self adjustSpawn:16] punkies:[self adjustSpawn:6] mascots:0 queenies:0]];
    [rounds addObject:[[Round alloc] initWithMessage1:@"The fastest enemies in the"
                                             ...
                                             message3:@"you catch them all?"
                                                bonus:80 chubbies:0 jeanies:0 lankies:0 smarties:0 airplanes:[self adjustSpawn:7]
    ...
    [rounds addObject:[[Round alloc] initWithMessage1:@"Get ready for an aerial"
                                             message2:@"assault!"
                                             message3:nil
                                                bonus:75 chubbies:[self adjustSpawn:12] jeanies:0 lankies:0 smarties:0 airplanes:0
                                              banners:0 bandies:[self adjustSpawn:12] cheeries:0 punkies:0 mascots:[self adjustSpawn:12] queenies:0]];
    [rounds addObject:[[Round alloc] initWithMessage1:@"You've passed level 20!" //20
                                             message2:@"Must be doing something"
                                             message3:@"right."
                                                bonus:70 chubbies:[self adjustSpawn:6] jeanies:4 lankies:3 smarties:6 airplanes:5
                                              banners:4 bandies:[self adjustSpawn:6] cheeries:[self adjustSpawn:15] punkies:2 mascots:3 queenies:1]];
    [rounds addObject:[[Round alloc] initWithMessage1:@"What are these kids heading"
                                             ...
                                             message3:@"important. Stop them!"
                                              ...
                                              banners:4 bandies:4 cheeries:[self adjustSpawn:10] punkies:2 mascots:2 queenies:1]];
    [rounds addObject:[[Round alloc] initWithMessage1:@"Finally! The whole roster"
                                             ...
                                             message3:nil
                                              ...
                                              banners:0 bandies:0 cheeries:5 punkies:0 mascots:0 queenies:[self adjustSpawn:3]]];
    [rounds addObject:[[Round alloc] initWithMessage1:@"After round 20 enemy"
                                             ...
                                             message3:@"after 25 they triple!"
                                                bonus:55 chubbies:0 jeanies:0 lankies:[self adjustSpawn:10] smarties:0 airplanes:0
    ...
    [rounds addObject:[[Round alloc] initWithMessage1:@"The prom queen cometh..."
                                             ...
                                             message3:nil
                                              ...
                                              banners:0 bandies:[self adjustSpawn:5] cheeries:[self adjustSpawn:10] punkies:0 mascots:[self adjustSpawn:5] queenies:0]];
    [rounds addObject:[[Round alloc] initWithMessage1:@"The next round has all" //15
                                             ...
                                             message3:@"event. Except a sport."
                                              ...
                                              banners:0 bandies:1 cheeries:2 punkies:1 mascots:[self adjustSpawn:8] queenies:0]];
    [rounds addObject:[[Round alloc] initWithMessage1:@"Ever wonder if mascots"
                                             ...
                                             message3:@"Yeah, me neither."
                                                bonus:46 chubbies:0 jeanies:2 lankies:0 smarties:2 airplanes:0
                                              banners:0 bandies:0 cheeries:0 punkies:[self adjustSpawn:9] mascots:0 queenies:0]];
    [rounds addObject:[[Round alloc] initWithMessage1:@"Rebellious punkies on the"
                                             ...
                                             message3:@"from a bad 80s movie."
                                              ...
                                              banners:[self adjustSpawn:10] bandies:0 cheeries:0 punkies:0 mascots:0 queenies:0]];
    [rounds addObject:[[Round alloc] initWithMessage1:@"These banners are tough,"
                                             ...
                                             message3:@"'unflappable'. No? Sorry."
                                              ...
                                              banners:0 bandies:0 cheeries:[self adjustSpawn:12] punkies:0 mascots:0 queenies:0]];
    [rounds addObject:[[Round alloc] initWithMessage1:@"A whole bunch of"
                                             ...
                                             message3:@"your way."
                                              ...
                                              banners:0 bandies:[self adjustSpawn:4] cheeries:0 punkies:0 mascots:0 queenies:0]];
    [rounds addObject:[[Round alloc] initWithMessage1:@"You've passed level 10!" //10
                                             ...
                                             message3:@"of the map covered."
                                                bonus:35 chubbies:4 jeanies:[self adjustSpawn:6] lankies:4 smarties:[self adjustSpawn:7] airplanes:1
    ...
    [rounds addObject:[[Round alloc] initWithMessage1:@"Choosing which tower to" 
                                             ...
                                             message3:@"choosing where to place it."
                                                bonus:30 chubbies:0 jeanies:[self adjustSpawn:6] lankies:0 smarties:[self adjustSpawn:6] airplanes:0
    ...
    [rounds addObject:[[Round alloc] initWithMessage1:@"Check out the instructions" 
                                             ...
                                             message3:@"types and immunities."
                                                bonus:28 chubbies:[self adjustSpawn:4] jeanies:0 lankies:2 smarties:2 airplanes:0
                                              banners:0 bandies:0 cheeries:0 punkies:0 mascots:0 queenies:0]];
    ...
    [rounds addObject:[[Round alloc] initWithMessage1:@"Airplanes are on their" //5
                                             ...
                                             message3:@"The Matron is your friend."
                                                bonus:26 chubbies:0 jeanies:3 lankies:0 smarties:[self adjustSpawn:5] airplanes:0
                                              banners:0 bandies:0 cheeries:0 punkies:2 mascots:0 queenies:0]];
    [rounds addObject:[[Round alloc] initWithMessage1:@"Upgrading towers can go" 
                                             ...
                                             message3:@"use it in your strategy."
                                                bonus:25 chubbies:0 jeanies:2 lankies:0 smarties:[self adjustSpawn:3] airplanes:0
    ...
    [rounds addObject:[[Round alloc] initWithMessage1:@"Have you checked out" 
                                             ...
                                             message3:@"on the instructions page?" 
                                                bonus:24 chubbies:[self adjustSpawn:4] jeanies:0 lankies:0 smarties:0 airplanes:0
                                              banners:0 bandies:0 cheeries:0 punkies:0 mascots:0 queenies:0]];
    [rounds addObject:[[Round alloc] initWithMessage1:@"Some towers are only" 
                                             ...
                                             message3:@"passed certain rounds." 
                                                bonus:22 chubbies:0 jeanies:2 lankies:0 smarties:[self adjustSpawn:5] airplanes:0
                                              banners:0 bandies:0 cheeries:0 punkies:0 mascots:0 queenies:0]];
